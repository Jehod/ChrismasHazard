...
#password_mail = "blzw tdrs xcis astw"
##password_mail utilise mot de passe d'application genere depuis la boite mail
year = str(datetime.datetime.now().year)

FROM = "Le père Noël Mystère "

CONTENT = " \r\n MESSAGE AUTOMATIQUE. \r\n Tu as reçu ce mail car tu participes au Noël mystère "+year + ". \r\n \r\n" \
          "Evénement spécial cette année: Noël tombe le 25 décembre à midi à Echirolles! \r\n \r\n"\
